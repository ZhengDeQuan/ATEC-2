...
def get_positive_example(df , side):
    ...
    sent1 = [list(map(int, sen.split('/'))) for sen in sent1]
    sent2 = [list(map(int, sen.split('/'))) for sen in sent2]
    q = df["sent1id_"+side]
    r = df["sent2id_"+side]
    all_sen = q.append(r)
    del q
    del r
    all_sen = [list(map(int, sen.split('/'))) for sen in all_sen]
...
def get_example(df , side):
    ...
    label = list(df['label'])
    # print("len_sent1 = ",len(sent1))
    # print("len_sent2 = ",len(sent2))
    sent1 = [list(map(int, sen.split('/'))) for sen in sent1]
    sent2 = [list(map(int, sen.split('/'))) for sen in sent2]
...
if __name__=="__main__":
    ...
    # sent1 , sent2 , label = get_example(df1 , side = "word")
    # print(len(sent1))
    # print(len(label))
    # print(sent1[:3])
    # print("********")
    # sp1,sp2,all_sen=get_positive_example(df1, side="word")
    # print("num_of_sp1 =",len(sp1))
    # print("num_of_sp2 =",len(sp2))
    # print("num_all_sen = ",len(all_sen))
    # print(sp1[:3])
    # print("********")
    # print(sp2[:3])
    # print(all_sen[:3])
    ...
    if len(all_pred_value) > 0:
        ...
        df2.insert(len(df2.keys()),"yes_prob" , DataFrame(all_pred_value[:,1]) )
    topai(1 , df1)
    topai(2,  df2)
    topai(3,  df3)
    topai(4 , df4)