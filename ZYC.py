...
#训练某个模型，模型接受的输入包括：fix train data，random train data，val data，embedding data
#coding=utf-8
...
arnn.train_model_with_random_sample_random(df_train = df1 , df_valid= df2,store_path=path)